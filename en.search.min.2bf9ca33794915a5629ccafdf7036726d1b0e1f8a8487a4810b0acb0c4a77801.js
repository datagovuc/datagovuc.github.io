...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.4adaab350a980befd923d51ca3eb3d88853603607d9069dfcd6c83d71d42e9d1.js',function(){input.required=false;search();});}
